...
## DrawableChooser
- :Constructors:<br /><br />::<br /><br />    DrawableChooser(**properties)<br />    new(title:str=None, label:str=None, drawable_type:GType, drawable:Gimp.Drawable=None) -> Gtk.Widget
...
- **set_drawable**`(*args, **kwargs)`
  - set_drawable(self, drawable:Gimp.Drawable)
