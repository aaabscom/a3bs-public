...
## ColorNotebook
- :Constructors:<br /><br />::<br /><br />    ColorNotebook(**properties)
...
- **do_channel_changed**`(bound native)`
  - channel_changed(self, channel:GimpUi.ColorSelectorChannel)
...
- **do_color_changed**`(bound native)`
  - color_changed(self, color:Gegl.Color)
...
- **do_model_visible_changed**`(bound native)`
  - model_visible_changed(self, model:GimpUi.ColorSelectorModel, visible:bool)
...
- **do_set_channel**`(bound native)`
  - set_channel(self, channel:GimpUi.ColorSelectorChannel)
...
- **do_set_color**`(bound native)`
  - set_color(self, color:Gegl.Color)

- **do_set_config**`(bound native)`
  - set_config(self, config:Gimp.ColorConfig)

- **do_set_focus_child**`(bound native)`
  - set_focus_child(self, child:Gtk.Widget=None)

- **do_set_format**`(bound native)`
  - set_format(self, format:Babl.Object)

- **do_set_model_visible**`(bound native)`
  - set_model_visible(self, model:GimpUi.ColorSelectorModel, visible:bool)

- **do_set_show_alpha**`(bound native)`
  - set_show_alpha(self, show_alpha:bool)

- **do_set_simulation**`(bound native)`
  - set_simulation(self, profile:Gimp.ColorProfile, intent:Gimp.ColorRenderingIntent, bpc:bool)

- **do_set_toggles_sensitive**`(bound native)`
  - set_toggles_sensitive(self, sensitive:bool)

- **do_set_toggles_visible**`(bound native)`
  - set_toggles_visible(self, visible:bool)
...
- **do_simulation**`(bound native)`
  - simulation(self, enabled:bool)
...
- **enable_simulation**`(*args, **kwargs)`
  - enable_simulation(self, enabled:bool)
...
- **get_channel**`(*args, **kwargs)`
  - get_channel(self) -> GimpUi.ColorSelectorChannel
...
- **get_current_selector**`(*args, **kwargs)`
  - get_current_selector(self) -> GimpUi.ColorSelector
...
- **get_model_visible**`(*args, **kwargs)`
  - get_model_visible(self, model:GimpUi.ColorSelectorModel) -> bool
...
- **get_notebook**`(*args, **kwargs)`
  - get_notebook(self) -> Gtk.Notebook
...
- **get_selectors**`(*args, **kwargs)`
  - get_selectors(self) -> list
...
- **get_show_alpha**`(*args, **kwargs)`
  - get_show_alpha(self) -> bool

- **get_simulation**`(*args, **kwargs)`
  - get_simulation(self, profile:Gimp.ColorProfile, intent:Gimp.ColorRenderingIntent, bpc:bool) -> bool
...
- **get_toggles_sensitive**`(*args, **kwargs)`
  - get_toggles_sensitive(self) -> bool

- **get_toggles_visible**`(*args, **kwargs)`
  - get_toggles_visible(self) -> bool
...
- **set_has_page**`(*args, **kwargs)`
  - set_has_page(self, page_type:GType, has_page:bool) -> Gtk.Widget
...
- **set_show_alpha**`(*args, **kwargs)`
  - set_show_alpha(self, show_alpha:bool)

- **set_simulation**`(*args, **kwargs)`
  - set_simulation(self, profile:Gimp.ColorProfile, intent:Gimp.ColorRenderingIntent, bpc:bool)
...
- **set_toggles_sensitive**`(*args, **kwargs)`
  - set_toggles_sensitive(self, sensitive:bool)

- **set_toggles_visible**`(*args, **kwargs)`
  - set_toggles_visible(self, visible:bool)
