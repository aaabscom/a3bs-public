...
## ChainButton
- :Constructors:<br /><br />::<br /><br />    ChainButton(**properties)<br />    new(position:GimpUi.ChainPosition) -> Gtk.Widget
...
- **get_button**`(*args, **kwargs)`
  - get_button(self) -> Gtk.Button
...
- **set_icon_size**`(*args, **kwargs)`
  - set_icon_size(self, size:Gtk.IconSize)
