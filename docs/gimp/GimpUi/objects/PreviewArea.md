...
## PreviewArea
- :Constructors:<br /><br />::<br /><br />    PreviewArea(**properties)<br />    new() -> Gtk.Widget
...
- **blend**`(*args, **kwargs)`
  - blend(self, x:int, y:int, width:int, height:int, type:Gimp.ImageType, buf1:list, rowstride1:int, buf2:list, rowstride2:int, opacity:int)
...
- **draw**`(*args, **kwargs)`
  - draw(self, x:int, y:int, width:int, height:int, type:Gimp.ImageType, buf:list, rowstride:int)
...
- **fill**`(*args, **kwargs)`
  - fill(self, x:int, y:int, width:int, height:int, red:int, green:int, blue:int)
...
- **mask**`(*args, **kwargs)`
  - mask(self, x:int, y:int, width:int, height:int, type:Gimp.ImageType, buf1:list, rowstride1:int, buf2:list, rowstride2:int, mask:list, rowstride_mask:int)

- **menu_popup**`(*args, **kwargs)`
  - menu_popup(self, event:Gdk.EventButton=None)
...
- **set_colormap**`(*args, **kwargs)`
  - set_colormap(self, colormap:list, num_colors:int)
...
- **set_max_size**`(*args, **kwargs)`
  - set_max_size(self, width:int, height:int)
