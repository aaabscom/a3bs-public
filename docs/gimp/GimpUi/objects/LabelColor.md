...
## LabelColor
- :Constructors:<br /><br />::<br /><br />    LabelColor(**properties)<br />    new(label:str, color:Gegl.Color, editable:bool) -> Gtk.Widget
...
- **get_color_widget**`(*args, **kwargs)`
  - get_color_widget(self) -> Gtk.Widget
...
- **set_value**`(*args, **kwargs)`
  - set_value(self, value:Gegl.Color)
