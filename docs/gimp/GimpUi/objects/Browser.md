...
## Browser
- :Constructors:<br /><br />::<br /><br />    Browser(**properties)<br />    new() -> Gtk.Widget
...
- **add1**`(*args, **kwargs)`
  - add1(self, child:Gtk.Widget)

- **add2**`(*args, **kwargs)`
  - add2(self, child:Gtk.Widget)
...
- **do_accept_position**`(bound native)`
  - accept_position(self) -> bool
...
- **do_cancel_position**`(bound native)`
  - cancel_position(self) -> bool
...
- **do_cycle_child_focus**`(bound native)`
  - cycle_child_focus(self, reverse:bool) -> bool

- **do_cycle_handle_focus**`(bound native)`
  - cycle_handle_focus(self, reverse:bool) -> bool
...
- **do_move_handle**`(bound native)`
  - move_handle(self, scroll:Gtk.ScrollType) -> bool
...
- **do_toggle_handle_focus**`(bound native)`
  - toggle_handle_focus(self) -> bool
...
- **get_child1**`(*args, **kwargs)`
  - get_child1(self) -> Gtk.Widget or None

- **get_child2**`(*args, **kwargs)`
  - get_child2(self) -> Gtk.Widget or None
...
- **get_left_vbox**`(*args, **kwargs)`
  - get_left_vbox(self) -> Gtk.Box
...
- **get_right_vbox**`(*args, **kwargs)`
  - get_right_vbox(self) -> Gtk.Box
...
- **pack1**`(self, child, resize=False, shrink=True)`
  - pack1(self, child:Gtk.Widget, resize:bool, shrink:bool)

- **pack2**`(self, child, resize=True, shrink=True)`
  - pack2(self, child:Gtk.Widget, resize:bool, shrink:bool)
...
- **set_search_summary**`(*args, **kwargs)`
  - set_search_summary(self, summary:str)
...
- **set_wide_handle**`(*args, **kwargs)`
  - set_wide_handle(self, wide:bool)

- **set_widget**`(*args, **kwargs)`
  - set_widget(self, widget:Gtk.Widget)
