...
## NumberPairEntry
- :Constructors:<br /><br />::<br /><br />    NumberPairEntry(**properties)<br />    new(separators:str, allow_simplification:bool, min_valid_value:float, max_valid_value:float) -> Gtk.Widget
...
- **get_aspect**`(*args, **kwargs)`
  - get_aspect(self) -> GimpUi.AspectType
...
- **get_default_text**`(*args, **kwargs)`
  - get_default_text(self) -> str or None

- **get_default_values**`(*args, **kwargs)`
  - get_default_values(self) -> left:float, right:float
...
- **get_ratio**`(*args, **kwargs)`
  - get_ratio(self) -> float
...
- **get_user_override**`(*args, **kwargs)`
  - get_user_override(self) -> bool
...
- **get_values**`(*args, **kwargs)`
  - get_values(self) -> left:float, right:float
...
- **set_aspect**`(*args, **kwargs)`
  - set_aspect(self, aspect:GimpUi.AspectType)
...
- **set_default_text**`(*args, **kwargs)`
  - set_default_text(self, string:str)

- **set_default_values**`(*args, **kwargs)`
  - set_default_values(self, left:float, right:float)
...
- **set_ratio**`(*args, **kwargs)`
  - set_ratio(self, ratio:float)
...
- **set_user_override**`(*args, **kwargs)`
  - set_user_override(self, user_override:bool)

- **set_valign**`(*args, **kwargs)`
  - set_valign(self, align:Gtk.Align)

- **set_values**`(*args, **kwargs)`
  - set_values(self, left:float, right:float)
