...
## PageSelector
- :Constructors:<br /><br />::<br /><br />    PageSelector(**properties)<br />    new() -> Gtk.Widget
...
- **get_page_label**`(*args, **kwargs)`
  - get_page_label(self, page_no:int) -> str or None

- **get_page_thumbnail**`(*args, **kwargs)`
  - get_page_thumbnail(self, page_no:int) -> GdkPixbuf.Pixbuf or None
...
- **get_selected_pages**`(*args, **kwargs)`
  - get_selected_pages(self) -> list

- **get_selected_range**`(*args, **kwargs)`
  - get_selected_range(self) -> str
...
- **get_target**`(*args, **kwargs)`
  - get_target(self) -> GimpUi.PageSelectorTarget
...
- **page_is_selected**`(*args, **kwargs)`
  - page_is_selected(self, page_no:int) -> bool
...
- **select_page**`(*args, **kwargs)`
  - select_page(self, page_no:int)

- **select_range**`(*args, **kwargs)`
  - select_range(self, range:str)
...
- **set_page_label**`(*args, **kwargs)`
  - set_page_label(self, page_no:int, label:str)

- **set_page_thumbnail**`(*args, **kwargs)`
  - set_page_thumbnail(self, page_no:int, thumbnail:GdkPixbuf.Pixbuf)
...
- **set_target**`(*args, **kwargs)`
  - set_target(self, target:GimpUi.PageSelectorTarget)
...
- **unselect_all**`(*args, **kwargs)`
  - unselect_all(self)

- **unselect_page**`(*args, **kwargs)`
  - unselect_page(self, page_no:int)
