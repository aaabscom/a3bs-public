...
## ColorScale
- :Constructors:<br /><br />::<br /><br />    ColorScale(**properties)<br />    new(orientation:Gtk.Orientation, channel:GimpUi.ColorSelectorChannel) -> Gtk.Widget
...
- **do_format_value**`(bound native)`
  - format_value(self, value:float) -> str

- **do_get_accessible**`(bound native)`
  - get_accessible(self) -> Atk.Object

- **do_get_layout_offsets**`(bound native)`
...
- **do_get_range_border**`(bound native)`
  - get_range_border(self, border_:Gtk.Border)

- **do_get_range_size_request**`(bound native)`
  - get_range_size_request(self, orientation:Gtk.Orientation, minimum:int, natural:int)
...
- **get_draw_value**`(*args, **kwargs)`
  - get_draw_value(self) -> bool

- **get_events**`(*args, **kwargs)`
  - get_events(self) -> int

- **get_fill_level**`(*args, **kwargs)`
  - get_fill_level(self) -> float

- **get_flippable**`(*args, **kwargs)`
...
- **get_lower_stepper_sensitivity**`(*args, **kwargs)`
...
- **get_min_slider_size**`(*args, **kwargs)`
...
- **get_upper_stepper_sensitivity**`(*args, **kwargs)`
...
- **set_inverted**`(*args, **kwargs)`
  - set_inverted(self, setting:bool)

- **set_lower_stepper_sensitivity**`(*args, **kwargs)`
...
- **set_min_slider_size**`(*args, **kwargs)`
...
- **set_upper_stepper_sensitivity**`(*args, **kwargs)`
