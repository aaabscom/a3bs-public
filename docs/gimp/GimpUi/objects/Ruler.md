...
## Ruler
- :Constructors:<br /><br />::<br /><br />    Ruler(**properties)<br />    new(orientation:Gtk.Orientation) -> Gtk.Widget
...
- **add_track_widget**`(*args, **kwargs)`
  - add_track_widget(self, widget:Gtk.Widget)
...
- **get_range**`(*args, **kwargs)`
  - get_range(self) -> lower:float, upper:float, max_size:float
...
- **remove_track_widget**`(*args, **kwargs)`
  - remove_track_widget(self, widget:Gtk.Widget)
...
- **set_position**`(*args, **kwargs)`
  - set_position(self, position:float)
...
- **set_range**`(*args, **kwargs)`
  - set_range(self, lower:float, upper:float, max_size:float)
