...
## ColorArea
- :Constructors:<br /><br />::<br /><br />    ColorArea(**properties)<br />    new(color:Gegl.Color, type:GimpUi.ColorAreaType, drag_mask:Gdk.ModifierType) -> Gtk.Widget
...
- **enable_drag**`(*args, **kwargs)`
  - enable_drag(self, drag_mask:Gdk.ModifierType)
...
- **set_draw_border**`(*args, **kwargs)`
  - set_draw_border(self, draw_border:bool)
...
- **set_out_of_gamut**`(*args, **kwargs)`
  - set_out_of_gamut(self, out_of_gamut:bool)
