...
## StringComboBox
- :Constructors:<br /><br />::<br /><br />    StringComboBox(**properties)<br />    new(model:Gtk.TreeModel, id_column:int, label_column:int) -> Gtk.Widget
...
- **set_sensitivity**`(*args, **kwargs)`
  - set_sensitivity(self, func:GimpUi.StringSensitivityFunc, data=None)
