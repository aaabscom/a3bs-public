...
## OffsetArea
- :Constructors:<br /><br />::<br /><br />    OffsetArea(**properties)<br />    new(orig_width:int, orig_height:int) -> Gtk.Widget
...
- **set_offsets**`(*args, **kwargs)`
  - set_offsets(self, offset_x:int, offset_y:int)
