...
## ColorDisplayStack
- :Constructors:<br /><br />::<br /><br />    ColorDisplayStack(**properties)<br />    new() -> GimpUi.ColorDisplayStack
...
### Runtime functions
- **add**`(*args, **kwargs)`
  - add(self, display:GimpUi.ColorDisplay)
...
- **clone**`(*args, **kwargs)`
  - clone(self) -> GimpUi.ColorDisplayStack
...
- **remove**`(*args, **kwargs)`
  - remove(self, display:GimpUi.ColorDisplay)

- **reorder_down**`(*args, **kwargs)`
  - reorder_down(self, display:GimpUi.ColorDisplay)

- **reorder_up**`(*args, **kwargs)`
  - reorder_up(self, display:GimpUi.ColorDisplay)
