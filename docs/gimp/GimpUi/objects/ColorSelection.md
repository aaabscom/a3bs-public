...
## ColorSelection
- :Constructors:<br /><br />::<br /><br />    ColorSelection(**properties)<br />    new() -> Gtk.Widget
...
- **get_notebook**`(*args, **kwargs)`
  - get_notebook(self) -> Gtk.Widget

- **get_old_color**`(*args, **kwargs)`
  - get_old_color(self) -> Gegl.Color
...
- **set_old_color**`(*args, **kwargs)`
  - set_old_color(self, color:Gegl.Color)
