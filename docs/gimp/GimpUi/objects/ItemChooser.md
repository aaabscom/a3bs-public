...
## ItemChooser
- :Constructors:<br /><br />::<br /><br />    ItemChooser(**properties)<br />    new(title:str=None, label:str=None, item_type:GType, item:Gimp.Item=None) -> Gtk.Widget
...
- **new**`(*args, **kwargs)`
  - new(title:str=None, label:str=None, item_type:GType, item:Gimp.Item=None) -> Gtk.Widget
