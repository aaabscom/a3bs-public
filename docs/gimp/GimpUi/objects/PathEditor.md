...
## PathEditor
- :Constructors:<br /><br />::<br /><br />    PathEditor(**properties)<br />    new(title:str, path:str=None) -> Gtk.Widget
...
- **get_dir_writable**`(*args, **kwargs)`
  - get_dir_writable(self, directory:str) -> bool
...
- **get_writable_path**`(*args, **kwargs)`
  - get_writable_path(self) -> str
...
- **set_dir_writable**`(*args, **kwargs)`
  - set_dir_writable(self, directory:str, writable:bool)
...
- **set_writable_path**`(*args, **kwargs)`
  - set_writable_path(self, path:str)
