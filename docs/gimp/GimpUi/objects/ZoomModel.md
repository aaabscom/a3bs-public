...
## ZoomModel
- :Constructors:<br /><br />::<br /><br />    ZoomModel(**properties)<br />    new() -> GimpUi.ZoomModel
...
- **get_fraction**`(*args, **kwargs)`
  - get_fraction(self) -> numerator:int, denominator:int
...
- **zoom**`(*args, **kwargs)`
  - zoom(self, zoom_type:GimpUi.ZoomType, scale:float)

- **zoom_step**`(*args, **kwargs)`
  - zoom_step(zoom_type:GimpUi.ZoomType, scale:float, delta:float) -> float
