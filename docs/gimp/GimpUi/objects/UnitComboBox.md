...
## UnitComboBox
- :Constructors:<br /><br />::<br /><br />    UnitComboBox(**properties)<br />    new() -> Gtk.Widget<br />    new_with_model(model:GimpUi.UnitStore) -> Gtk.Widget
...
- **set_active**`(*args, **kwargs)`
  - set_active(self, unit:Gimp.Unit)
