...
## IntRadioFrame
- :Constructors:<br /><br />::<br /><br />    IntRadioFrame(**properties)<br />    new(labels:list) -> Gtk.Widget<br />    new_from_store(title:str, store:GimpUi.IntStore) -> Gtk.Widget
...
- **do_compute_child_allocation**`(bound native)`
...
- **set_label_align**`(*args, **kwargs)`
  - set_label_align(self, xalign:float, yalign:float)

- **set_label_widget**`(*args, **kwargs)`
...
- **set_sensitivity**`(*args, **kwargs)`
  - set_sensitivity(self, func:GimpUi.IntRadioFrameSensitivityFunc, data=None)

- **set_shadow_type**`(*args, **kwargs)`
...
- **set_title**`(*args, **kwargs)`
  - set_title(self, title:str, with_mnemonic:bool)
