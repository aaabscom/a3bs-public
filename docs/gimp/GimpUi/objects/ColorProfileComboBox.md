...
- :Constructors:<br /><br />::<br /><br />    ColorProfileComboBox(**properties)<br />    new(dialog:Gtk.Widget, history:Gio.File) -> Gtk.Widget<br />    new_with_model(dialog:Gtk.Widget, model:Gtk.TreeModel) -> Gtk.Widget
...
- **get_active_file**`(*args, **kwargs)`
  - get_active_file(self) -> Gio.File
...
- **set_active_file**`(*args, **kwargs)`
  - set_active_file(self, file:Gio.File, label:str)
...
- **set_active_profile**`(*args, **kwargs)`
  - set_active_profile(self, profile:Gimp.ColorProfile)
