...
## ColorScales
- :Constructors:<br /><br />::<br /><br />    ColorScales(**properties)
...
- **enable_simulation**`(*args, **kwargs)`
  - enable_simulation(self, enabled:bool) -> bool
...
- **get_show_rgb_u8**`(*args, **kwargs)`
  - get_show_rgb_u8(self) -> bool
...
- **set_show_rgb_u8**`(*args, **kwargs)`
  - set_show_rgb_u8(self, show_rgb_u8:bool)
