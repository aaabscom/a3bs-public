...
## ColorScaleEntry
- :Constructors:<br /><br />::<br /><br />    ColorScaleEntry(**properties)<br />    new(text:str, value:float, lower:float, upper:float, digits:int) -> Gtk.Widget
...
- **do_mnemonic_widget_changed**`(bound native)`
  - mnemonic_widget_changed(self, widget:Gtk.Widget)
...
- **get_label**`(*args, **kwargs)`
  - get_label(self) -> Gtk.Label

- **get_logarithmic**`(*args, **kwargs)`
  - get_logarithmic(self) -> bool
...
- **get_spin_button**`(*args, **kwargs)`
  - get_spin_button(self) -> Gtk.Widget
...
- **set_bounds**`(*args, **kwargs)`
  - set_bounds(self, lower:float, upper:float, limit_scale:bool)
...
- **set_logarithmic**`(*args, **kwargs)`
  - set_logarithmic(self, logarithmic:bool)
