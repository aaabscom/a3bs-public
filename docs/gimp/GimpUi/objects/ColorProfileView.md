...
## ColorProfileView
- :Constructors:<br /><br />::<br /><br />    ColorProfileView(**properties)<br />    new() -> Gtk.Widget
...
- **backward_display_line**`(*args, **kwargs)`
  - backward_display_line(self, iter:Gtk.TextIter) -> bool

- **backward_display_line_start**`(*args, **kwargs)`
...
- **buffer_to_window_coords**`(*args, **kwargs)`
...
- **do_extend_selection**`(bound native)`
...
- **forward_display_line**`(*args, **kwargs)`
  - forward_display_line(self, iter:Gtk.TextIter) -> bool

- **forward_display_line_end**`(*args, **kwargs)`
...
- **get_hscroll_policy**`(*args, **kwargs)`
...
- **get_pixels_above_lines**`(*args, **kwargs)`
  - get_pixels_above_lines(self) -> int

- **get_pixels_below_lines**`(*args, **kwargs)`
  - get_pixels_below_lines(self) -> int

- **get_pixels_inside_wrap**`(*args, **kwargs)`
...
- **place_cursor_onscreen**`(*args, **kwargs)`
...
- **reset_cursor_blink**`(*args, **kwargs)`
...
- **set_border_window_size**`(*args, **kwargs)`
  - set_border_window_size(self, type:Gtk.TextWindowType, size:int)

- **set_bottom_margin**`(*args, **kwargs)`
...
- **set_cursor_visible**`(*args, **kwargs)`
...
- **set_hscroll_policy**`(*args, **kwargs)`
...
- **set_top_margin**`(*args, **kwargs)`
  - set_top_margin(self, top_margin:int)

- **set_vadjustment**`(*args, **kwargs)`
...
- **starts_display_line**`(*args, **kwargs)`
...
- **window_to_buffer_coords**`(*args, **kwargs)`
