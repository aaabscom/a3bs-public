...
## GradientChooser
- :Constructors:<br /><br />::<br /><br />    GradientChooser(**properties)<br />    new(title:str=None, label:str=None, gradient:Gimp.Gradient=None) -> Gtk.Widget
...
- **do_resource_set**`(bound native)`
  - resource_set(self, resource:Gimp.Resource, dialog_closing:bool)
...
- **get_resource**`(*args, **kwargs)`
  - get_resource(self) -> Gimp.Resource
...
- **set_resource**`(*args, **kwargs)`
  - set_resource(self, resource:Gimp.Resource)
