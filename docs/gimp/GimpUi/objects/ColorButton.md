...
## ColorButton
- :Constructors:<br /><br />::<br /><br />    ColorButton(**properties)<br />    new(title:str, width:int, height:int, color:Gegl.Color, type:GimpUi.ColorAreaType) -> Gtk.Widget
...
- **do_extended_clicked**`(bound native)`
  - extended_clicked(self, modifier_state:Gdk.ModifierType)
...
- **do_get_action_type**`(bound native)`
  - get_action_type(self) -> GType
...
- **do_set_related_action**`(*args, **kwargs)`
...
- **get_action_group**`(*args, **kwargs)`
  - get_action_group(self) -> Gio.SimpleActionGroup

- **get_action_name**`(*args, **kwargs)`
  - get_action_name(self) -> str or None

- **get_action_target_value**`(*args, **kwargs)`
...
- **get_always_show_image**`(*args, **kwargs)`
...
- **get_focus_on_click**`(self, *args, **kwargs)`
...
- **get_image_position**`(*args, **kwargs)`
...
- **get_related_action**`(*args, **kwargs)`
  - get_related_action(self) -> Gtk.Action

- **get_relief**`(*args, **kwargs)`
...
- **get_update**`(*args, **kwargs)`
  - get_update(self) -> bool

- **get_use_action_appearance**`(*args, **kwargs)`
  - get_use_action_appearance(self) -> bool

- **get_use_stock**`(*args, **kwargs)`
  - get_use_stock(self) -> bool

- **get_use_underline**`(*args, **kwargs)`
...
- **set_action_name**`(*args, **kwargs)`
  - set_action_name(self, action_name:str=None)

- **set_action_target_value**`(*args, **kwargs)`
...
- **set_always_show_image**`(*args, **kwargs)`
...
- **set_color_config**`(*args, **kwargs)`
  - set_color_config(self, config:Gimp.ColorConfig)
...
- **set_detailed_action_name**`(*args, **kwargs)`
...
- **set_focus_on_click**`(self, *args, **kwargs)`
...
- **set_image_position**`(*args, **kwargs)`
...
- **set_related_action**`(*args, **kwargs)`
  - set_related_action(self, action:Gtk.Action)

- **set_relief**`(*args, **kwargs)`
...
- **set_type**`(*args, **kwargs)`
  - set_type(self, type:GimpUi.ColorAreaType)

- **set_update**`(*args, **kwargs)`
  - set_update(self, continuous:bool)

- **set_use_action_appearance**`(*args, **kwargs)`
  - set_use_action_appearance(self, use_appearance:bool)

- **set_use_stock**`(*args, **kwargs)`
  - set_use_stock(self, use_stock:bool)

- **set_use_underline**`(*args, **kwargs)`
...
- **sync_action_properties**`(*args, **kwargs)`
