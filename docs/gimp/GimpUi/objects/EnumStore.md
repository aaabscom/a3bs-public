...
## EnumStore
- :Constructors:<br /><br />::<br /><br />    EnumStore(**properties)<br />    new(enum_type:GType) -> Gtk.ListStore<br />    new_with_range(enum_type:GType, minimum:int, maximum:int) -> Gtk.ListStore
