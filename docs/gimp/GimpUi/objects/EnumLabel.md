...
## EnumLabel
- :Constructors:<br /><br />::<br /><br />    EnumLabel(**properties)<br />    new(enum_type:GType, value:int) -> Gtk.Widget
...
- **do_activate_link**`(bound native)`
  - activate_link(self, uri:str) -> bool
...
- **do_populate_popup**`(bound native)`
  - populate_popup(self, menu:Gtk.Menu)
...
- **get_line_wrap**`(*args, **kwargs)`
  - get_line_wrap(self) -> bool

- **get_line_wrap_mode**`(*args, **kwargs)`
  - get_line_wrap_mode(self) -> Pango.WrapMode

- **get_lines**`(*args, **kwargs)`
  - get_lines(self) -> int
...
- **get_mnemonic_widget**`(*args, **kwargs)`
  - get_mnemonic_widget(self) -> Gtk.Widget or None
...
- **get_single_line_mode**`(*args, **kwargs)`
...
- **get_track_visited_links**`(*args, **kwargs)`
  - get_track_visited_links(self) -> bool

- **get_use_markup**`(*args, **kwargs)`
...
- **get_xalign**`(*args, **kwargs)`
  - get_xalign(self) -> float

- **get_yalign**`(*args, **kwargs)`
...
- **set_text_with_mnemonic**`(*args, **kwargs)`
...
- **set_track_visited_links**`(*args, **kwargs)`
  - set_track_visited_links(self, track_links:bool)

- **set_use_markup**`(*args, **kwargs)`
...
- **set_xalign**`(*args, **kwargs)`
  - set_xalign(self, xalign:float)

- **set_yalign**`(*args, **kwargs)`
