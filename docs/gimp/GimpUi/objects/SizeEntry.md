...
## SizeEntry
- :Constructors:<br /><br />::<br /><br />    SizeEntry(**properties)<br />    new(number_of_fields:int, unit:Gimp.Unit, unit_format:str, menu_show_pixels:bool, menu_show_percent:bool, show_refval:bool, spinbutton_width:int, update_policy:GimpUi.SizeEntryUpdatePolicy) -> Gtk.Widget
...
- **add_field**`(*args, **kwargs)`
  - add_field(self, value_spinbutton:Gtk.SpinButton, refval_spinbutton:Gtk.SpinButton=None)
...
- **attach_label**`(*args, **kwargs)`
  - attach_label(self, text:str, row:int, column:int, alignment:float) -> Gtk.Widget

- **attach_next_to**`(*args, **kwargs)`
...
- **get_column_homogeneous**`(*args, **kwargs)`
  - get_column_homogeneous(self) -> bool

- **get_column_spacing**`(*args, **kwargs)`
...
- **get_help_widget**`(*args, **kwargs)`
  - get_help_widget(self, field:int) -> Gtk.Widget
...
- **get_n_fields**`(*args, **kwargs)`
  - get_n_fields(self) -> int
...
- **get_refval**`(*args, **kwargs)`
  - get_refval(self, field:int) -> float
...
- **get_row_baseline_position**`(*args, **kwargs)`
  - get_row_baseline_position(self, row:int) -> Gtk.BaselinePosition

- **get_row_homogeneous**`(*args, **kwargs)`
  - get_row_homogeneous(self) -> bool

- **get_row_spacing**`(*args, **kwargs)`
...
- **get_unit_combo**`(*args, **kwargs)`
  - get_unit_combo(self) -> GimpUi.UnitComboBox

- **get_update_policy**`(*args, **kwargs)`
  - get_update_policy(self) -> GimpUi.SizeEntryUpdatePolicy
...
- **get_value**`(*args, **kwargs)`
  - get_value(self, field:int) -> float
...
- **insert_column**`(*args, **kwargs)`
  - insert_column(self, position:int)

- **insert_next_to**`(*args, **kwargs)`
...
- **set_column_homogeneous**`(*args, **kwargs)`
  - set_column_homogeneous(self, homogeneous:bool)

- **set_column_spacing**`(*args, **kwargs)`
...
- **set_pixel_digits**`(*args, **kwargs)`
  - set_pixel_digits(self, digits:int)
...
- **set_refval**`(*args, **kwargs)`
  - set_refval(self, field:int, refval:float)

- **set_refval_boundaries**`(*args, **kwargs)`
  - set_refval_boundaries(self, field:int, lower:float, upper:float)

- **set_refval_digits**`(*args, **kwargs)`
  - set_refval_digits(self, field:int, digits:int)

- **set_resize_mode**`(*args, **kwargs)`
  - set_resize_mode(self, resize_mode:Gtk.ResizeMode)

- **set_resolution**`(*args, **kwargs)`
  - set_resolution(self, field:int, resolution:float, keep_size:bool)

- **set_row_baseline_position**`(*args, **kwargs)`
  - set_row_baseline_position(self, row:int, pos:Gtk.BaselinePosition)

- **set_row_homogeneous**`(*args, **kwargs)`
  - set_row_homogeneous(self, homogeneous:bool)

- **set_row_spacing**`(*args, **kwargs)`
...
- **set_size**`(*args, **kwargs)`
  - set_size(self, field:int, lower:float, upper:float)
...
- **set_unit**`(*args, **kwargs)`
  - set_unit(self, unit:Gimp.Unit)

- **set_valign**`(*args, **kwargs)`
  - set_valign(self, align:Gtk.Align)

- **set_value**`(*args, **kwargs)`
  - set_value(self, field:int, value:float)

- **set_value_boundaries**`(*args, **kwargs)`
  - set_value_boundaries(self, field:int, lower:float, upper:float)
...
- **show_unit_menu**`(*args, **kwargs)`
  - show_unit_menu(self, show:bool)
