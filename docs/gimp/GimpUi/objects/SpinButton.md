...
## SpinButton
- :Constructors:<br /><br />::<br /><br />    SpinButton(**properties)<br />    new(adjustment:Gtk.Adjustment=None, climb_rate:float, digits:int) -> Gtk.Widget<br />    new_with_range(min:float, max:float, step:float) -> Gtk.Widget
