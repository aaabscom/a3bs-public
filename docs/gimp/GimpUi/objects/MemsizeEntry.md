...
## MemsizeEntry
- :Constructors:<br /><br />::<br /><br />    MemsizeEntry(**properties)<br />    new(value:int, lower:int, upper:int) -> Gtk.Widget
...
- **get_spinbutton**`(*args, **kwargs)`
  - get_spinbutton(self) -> Gtk.SpinButton
