...
## Operation
- :Constructors:<br /><br />::<br /><br />    Operation(**properties)
...
- **find_property**`(*args, **kwargs)`
  - find_property(operation_type:str, property_name:str) -> GObject.ParamSpec
...
- **get_key**`(*args, **kwargs)`
  - get_key(operation_type:str, key_name:str) -> str

- **get_op_version**`(*args, **kwargs)`
  - get_op_version(op_name:str) -> str
...
- **get_property_key**`(*args, **kwargs)`
  - get_property_key(operation_type:str, property_name:str, property_key_name:str) -> str
...
- **list_keys**`(*args, **kwargs)`
  - list_keys(operation_type:str) -> list

- **list_properties**`(*args, **kwargs)`
  - list_properties(operation_type:str) -> list

- **list_property_keys**`(*args, **kwargs)`
  - list_property_keys(operation_type:str, property_name:str) -> list
