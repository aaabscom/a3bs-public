...
## TileBackend
- :Constructors:<br /><br />::<br /><br />    TileBackend(**properties)
...
- **command**`(*args, **kwargs)`
  - command(self, command:Gegl.TileCommand, x:int, y:int, z:int, data=None)
...
- **get_flush_on_destroy**`(*args, **kwargs)`
  - get_flush_on_destroy(self) -> bool
...
- **get_tile_height**`(*args, **kwargs)`
  - get_tile_height(self) -> int

- **get_tile_size**`(*args, **kwargs)`
  - get_tile_size(self) -> int

- **get_tile_width**`(*args, **kwargs)`
  - get_tile_width(self) -> int
...
- **peek_storage**`(*args, **kwargs)`
  - peek_storage(self) -> Gegl.TileSource
...
- **set_extent**`(*args, **kwargs)`
  - set_extent(self, rectangle:Gegl.Rectangle)

- **set_flush_on_destroy**`(*args, **kwargs)`
  - set_flush_on_destroy(self, flush_on_destroy:bool)
...
- **unlink_swap**`(*args, **kwargs)`
  - unlink_swap(path:str)
