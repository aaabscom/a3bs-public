...
## AudioFragment
- :Constructors:<br /><br />::<br /><br />    AudioFragment(**properties)<br />    new(sample_rate:int, channels:int, channel_layout:int, max_samples:int) -> Gegl.AudioFragment
...
- **get_channel_layout**`(*args, **kwargs)`
  - get_channel_layout(self) -> int
...
- **get_max_samples**`(*args, **kwargs)`
  - get_max_samples(self) -> int
...
- **get_sample_count**`(*args, **kwargs)`
  - get_sample_count(self) -> int

- **get_sample_rate**`(*args, **kwargs)`
...
- **set_channel_layout**`(*args, **kwargs)`
  - set_channel_layout(self, channel_layout:int)

- **set_channels**`(*args, **kwargs)`
  - set_channels(self, channels:int)

- **set_data**`(self, *args, **kargs)`
  - documentation unavailable

- **set_max_samples**`(*args, **kwargs)`
  - set_max_samples(self, max_samples:int)

- **set_pos**`(*args, **kwargs)`
  - set_pos(self, pos:int)
...
- **set_sample_count**`(*args, **kwargs)`
  - set_sample_count(self, sample_count:int)

- **set_sample_rate**`(*args, **kwargs)`
  - set_sample_rate(self, sample_rate:int)
