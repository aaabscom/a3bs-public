...
## Processor
- :Constructors:<br /><br />::<br /><br />    Processor(**properties)
...
- **set_rectangle**`(*args, **kwargs)`
  - set_rectangle(self, rectangle:Gegl.Rectangle)
