...
## ProcedureConfig
- :Constructors:<br /><br />::<br /><br />    ProcedureConfig(**properties)
...
- **get_procedure**`(*args, **kwargs)`
  - get_procedure(self) -> Gimp.Procedure
...
- **set_color_array**`(*args, **kwargs)`
  - set_color_array(self, property_name:str, colors:list)

- **set_core_object_array**`(*args, **kwargs)`
