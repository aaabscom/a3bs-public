...
## LoadProcedure
- :Constructors:<br /><br />::<br /><br />    LoadProcedure(**properties)<br />    new(plug_in:Gimp.PlugIn, name:str, proc_type:Gimp.PDBProcType, run_func:Gimp.RunLoadFunc, run_data=None) -> Gimp.Procedure
