...
## Channel
- :Constructors:<br /><br />::<br /><br />    Channel(**properties)<br />    new(image:Gimp.Image, name:str, width:int, height:int, opacity:float, color:Gegl.Color) -> Gimp.Channel<br />    new_from_component(image:Gimp.Image, component:Gimp.ChannelType, name:str) -> Gimp.Channel
