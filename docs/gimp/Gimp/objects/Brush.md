...
## Brush
- :Constructors:<br /><br />::<br /><br />    Brush(**properties)<br />    new(name:str) -> Gimp.Brush
...
- **get_angle**`(*args, **kwargs)`
  - get_angle(self) -> bool, angle:float

- **get_aspect_ratio**`(*args, **kwargs)`
...
- **get_hardness**`(*args, **kwargs)`
  - get_hardness(self) -> bool, hardness:float
...
- **get_radius**`(*args, **kwargs)`
  - get_radius(self) -> bool, radius:float

- **get_shape**`(*args, **kwargs)`
  - get_shape(self) -> bool, shape:Gimp.BrushGeneratedShape

- **get_spacing**`(*args, **kwargs)`
  - get_spacing(self) -> int

- **get_spikes**`(*args, **kwargs)`
  - get_spikes(self) -> bool, spikes:int
...
- **is_generated**`(*args, **kwargs)`
  - is_generated(self) -> bool
...
- **set_aspect_ratio**`(*args, **kwargs)`
  - set_aspect_ratio(self, aspect_ratio_in:float) -> bool, aspect_ratio_out:float

- **set_data**`(self, *args, **kargs)`
  - documentation unavailable

- **set_hardness**`(*args, **kwargs)`
  - set_hardness(self, hardness_in:float) -> bool, hardness_out:float
...
- **set_radius**`(*args, **kwargs)`
  - set_radius(self, radius_in:float) -> bool, radius_out:float

- **set_shape**`(*args, **kwargs)`
  - set_shape(self, shape_in:Gimp.BrushGeneratedShape) -> bool, shape_out:Gimp.BrushGeneratedShape

- **set_spacing**`(*args, **kwargs)`
  - set_spacing(self, spacing:int) -> bool

- **set_spikes**`(*args, **kwargs)`
  - set_spikes(self, spikes_in:int) -> bool, spikes_out:int
