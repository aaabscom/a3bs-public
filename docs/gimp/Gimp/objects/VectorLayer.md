...
## VectorLayer
- :Constructors:<br /><br />::<br /><br />    VectorLayer(**properties)<br />    new(image:Gimp.Image, path:Gimp.Path) -> Gimp.VectorLayer
...
- **get_by_id**`(*args, **kwargs)`
  - get_by_id(layer_id:int) -> Gimp.VectorLayer or None
...
- **get_enable_fill**`(*args, **kwargs)`
  - get_enable_fill(self) -> bool

- **get_enable_stroke**`(*args, **kwargs)`
  - get_enable_stroke(self) -> bool

- **get_expanded**`(*args, **kwargs)`
  - get_expanded(self) -> bool

- **get_fill_color**`(*args, **kwargs)`
  - get_fill_color(self) -> Gegl.Color

- **get_fill_pattern**`(*args, **kwargs)`
  - get_fill_pattern(self) -> Gimp.Pattern
...
- **get_stroke_cap_style**`(*args, **kwargs)`
  - get_stroke_cap_style(self) -> Gimp.CapStyle

- **get_stroke_color**`(*args, **kwargs)`
  - get_stroke_color(self) -> Gegl.Color

- **get_stroke_dash_offset**`(*args, **kwargs)`
  - get_stroke_dash_offset(self) -> float

- **get_stroke_dash_pattern**`(*args, **kwargs)`
  - get_stroke_dash_pattern(self) -> bool, dashes:list

- **get_stroke_join_style**`(*args, **kwargs)`
  - get_stroke_join_style(self) -> Gimp.JoinStyle

- **get_stroke_miter_limit**`(*args, **kwargs)`
  - get_stroke_miter_limit(self) -> float

- **get_stroke_pattern**`(*args, **kwargs)`
  - get_stroke_pattern(self) -> Gimp.Pattern

- **get_stroke_width**`(*args, **kwargs)`
  - get_stroke_width(self) -> float

- **get_stroke_width_unit**`(*args, **kwargs)`
  - get_stroke_width_unit(self) -> Gimp.Unit
...
- **new**`(*args, **kwargs)`
  - new(image:Gimp.Image, path:Gimp.Path) -> Gimp.VectorLayer
...
- **set_enable_fill**`(*args, **kwargs)`
  - set_enable_fill(self, enable_fill:bool) -> bool

- **set_enable_stroke**`(*args, **kwargs)`
  - set_enable_stroke(self, enable_stroke:bool) -> bool

- **set_expanded**`(*args, **kwargs)`
  - set_expanded(self, expanded:bool) -> bool

- **set_fill_color**`(*args, **kwargs)`
  - set_fill_color(self, color:Gegl.Color) -> bool
...
- **set_stroke_cap_style**`(*args, **kwargs)`
  - set_stroke_cap_style(self, cap_style:Gimp.CapStyle) -> bool

- **set_stroke_color**`(*args, **kwargs)`
  - set_stroke_color(self, color:Gegl.Color) -> bool

- **set_stroke_dash_offset**`(*args, **kwargs)`
  - set_stroke_dash_offset(self, dash_offset:float) -> bool

- **set_stroke_dash_pattern**`(*args, **kwargs)`
  - set_stroke_dash_pattern(self, dashes:list) -> bool

- **set_stroke_join_style**`(*args, **kwargs)`
  - set_stroke_join_style(self, join_style:Gimp.JoinStyle) -> bool

- **set_stroke_miter_limit**`(*args, **kwargs)`
  - set_stroke_miter_limit(self, miter:float) -> bool

- **set_stroke_width**`(*args, **kwargs)`
  - set_stroke_width(self, width:float) -> bool

- **set_stroke_width_unit**`(*args, **kwargs)`
  - set_stroke_width_unit(self, unit:Gimp.Unit) -> bool
