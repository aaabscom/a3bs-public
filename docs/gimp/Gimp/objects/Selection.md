...
## Selection
- :Constructors:<br /><br />::<br /><br />    Selection(**properties)
...
- **border**`(*args, **kwargs)`
  - border(image:Gimp.Image, radius:int) -> bool

- **bounds**`(*args, **kwargs)`
  - bounds(image:Gimp.Image) -> bool, non_empty:bool, x1:int, y1:int, x2:int, y2:int
...
- **feather**`(*args, **kwargs)`
  - feather(image:Gimp.Image, radius:float) -> bool
...
- **float**`(*args, **kwargs)`
  - float(image:Gimp.Image, drawables:list, offx:int, offy:int) -> Gimp.Layer

- **flood**`(*args, **kwargs)`
  - flood(image:Gimp.Image) -> bool
...
- **grow**`(*args, **kwargs)`
  - grow(image:Gimp.Image, steps:int) -> bool
...
- **is_empty**`(*args, **kwargs)`
  - is_empty(image:Gimp.Image) -> bool
...
- **save**`(*args, **kwargs)`
  - save(image:Gimp.Image) -> Gimp.Channel
...
- **sharpen**`(*args, **kwargs)`
  - sharpen(image:Gimp.Image) -> bool

- **shrink**`(*args, **kwargs)`
  - shrink(image:Gimp.Image, steps:int) -> bool
...
- **translate**`(*args, **kwargs)`
  - translate(image:Gimp.Image, offx:int, offy:int) -> bool
...
- **value**`(*args, **kwargs)`
  - value(image:Gimp.Image, x:int, y:int) -> int
