...
## Display
- :Constructors:<br /><br />::<br /><br />    Display(**properties)<br />    new(image:Gimp.Image) -> Gimp.Display
...
- **get_by_id**`(*args, **kwargs)`
  - get_by_id(display_id:int) -> Gimp.Display or None
...
- **id_is_valid**`(*args, **kwargs)`
  - id_is_valid(display_id:int) -> bool
