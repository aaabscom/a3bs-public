...
## PDB
- :Constructors:<br /><br />::<br /><br />    PDB(**properties)
...
- **dump_to_file**`(*args, **kwargs)`
  - dump_to_file(self, file:Gio.File) -> bool
...
- **get_last_status**`(*args, **kwargs)`
  - get_last_status(self) -> Gimp.PDBStatusType
...
- **lookup_procedure**`(*args, **kwargs)`
  - lookup_procedure(self, procedure_name:str) -> Gimp.Procedure or None
...
- **procedure_exists**`(*args, **kwargs)`
  - procedure_exists(self, procedure_name:str) -> bool

- **query_procedures**`(*args, **kwargs)`
  - query_procedures(self, name:str, blurb:str, help:str, help_id:str, authors:str, copyright:str, date:str, proc_type:str) -> list
...
- **temp_procedure_name**`(*args, **kwargs)`
  - temp_procedure_name(self) -> str
