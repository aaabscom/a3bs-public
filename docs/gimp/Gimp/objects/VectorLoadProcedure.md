...
## VectorLoadProcedure
- :Constructors:<br /><br />::<br /><br />    VectorLoadProcedure(**properties)<br />    new(plug_in:Gimp.PlugIn, name:str, proc_type:Gimp.PDBProcType, extract_func:Gimp.ExtractVectorFunc, extract_data=None, run_func:Gimp.RunVectorLoadFunc, run_data=None) -> Gimp.Procedure
...
- **extract_dimensions**`(*args, **kwargs)`
  - extract_dimensions(self, file:Gio.File) -> bool, data:Gimp.VectorLoadData
...
- **get_thumbnail_loader**`(*args, **kwargs)`
...
- **set_thumbnail_loader**`(*args, **kwargs)`
