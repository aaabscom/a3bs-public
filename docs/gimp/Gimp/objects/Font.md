...
## Font
- :Constructors:<br /><br />::<br /><br />    Font(**properties)
...
- **get_by_name**`(*args, **kwargs)`
  - get_by_name(name:str) -> Gimp.Font or None
...
- **get_pango_font_description**`(*args, **kwargs)`
  - get_pango_font_description(self) -> Pango.FontDescription
