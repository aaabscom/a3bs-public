...
## ModuleDB
- :Constructors:<br /><br />::<br /><br />    ModuleDB(**properties)<br />    new(verbose:bool) -> Gimp.ModuleDB
...
- **get_item_type**`(*args, **kwargs)`
  - get_item_type(self) -> GType

- **get_load_inhibit**`(*args, **kwargs)`
  - get_load_inhibit(self) -> str

- **get_n_items**`(*args, **kwargs)`
...
- **get_verbose**`(*args, **kwargs)`
  - get_verbose(self) -> bool
...
- **set_load_inhibit**`(*args, **kwargs)`
  - set_load_inhibit(self, load_inhibit:str)
...
- **set_verbose**`(*args, **kwargs)`
  - set_verbose(self, verbose:bool)
