...
## SignalGroup
- :Constructors:<br /><br />::<br /><br />    SignalGroup(**properties)<br />    new(target_type:GType) -> GObject.SignalGroup
...
- **connect_closure**`(*args, **kwargs)`
  - connect_closure(self, detailed_signal:str, closure:GObject.Closure, after:bool)

- **connect_data**`(*args, **kwargs)`
  - connect_data(self, detailed_signal:str, c_handler:GObject.Callback, data=None, flags:GObject.ConnectFlags)
...
- **connect_swapped**`(*args, **kwargs)`
  - connect_swapped(self, detailed_signal:str, c_handler:GObject.Callback, data=None)
...
- **set_target**`(*args, **kwargs)`
  - set_target(self, target:GObject.Object=None)
