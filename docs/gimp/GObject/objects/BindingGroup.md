...
## BindingGroup
- :Constructors:<br /><br />::<br /><br />    BindingGroup(**properties)<br />    new() -> GObject.BindingGroup
...
### Runtime functions
- **bind**`(*args, **kwargs)`
  - bind(self, source_property:str, target:GObject.Object, target_property:str, flags:GObject.BindingFlags)

- **bind_full**`(*args, **kwargs)`
  - bind_full(self, source_property:str, target:GObject.Object, target_property:str, flags:GObject.BindingFlags, transform_to:GObject.Closure=None, transform_from:GObject.Closure=None)
...
- **dup_source**`(*args, **kwargs)`
  - dup_source(self) -> GObject.Object or None
...
- **set_source**`(*args, **kwargs)`
  - set_source(self, source:GObject.Object=None)
